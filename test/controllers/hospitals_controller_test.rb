...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { contact: @hospital.contact, hospital_id: @hospital.hospital_id, name: @hospital.name } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { contact: @hospital.contact, hospital_id: @hospital.hospital_id, name: @hospital.name } }
